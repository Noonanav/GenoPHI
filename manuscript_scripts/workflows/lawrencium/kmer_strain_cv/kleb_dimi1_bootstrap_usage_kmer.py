#!/usr/bin/env python3
"""
Bootstrap cross-validation workflow submission script for k-mer-based phage-host interaction modeling.
Edit the paths and parameters below, then run: python3 bootstrap_usage_kmer.py
"""
...
def main():
    ...
    output_dir = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/kmer_bootstrapping/kleb_dimi1/k4"
    ...
    ignore_families = True               # Whether to ignore protein families when defining k-mer features (TRUE for pure k-mer features)
    ...
    min_cluster_presence = "2"           # Minimum cluster presence
    ...
    # =============================================
    cmd = [
        "python3", "slurm_kmer_bootstrap_submit.py",
    ...
    # =============================================
    print("=" * 80)
    print("Bootstrap K-mer Cross-Validation Workflow Submission")
    print("=" * 80)
    ...
    try:
        ...
        if dry_run:
            ...
            print("\n✅ Bootstrap k-mer validation workflow submitted successfully!")
