...
def main():
    ...
    phenotype_matrix = "/global/scratch/users/anoonan/BRaVE/vibrio/vibrio_matrix_accessions_mod.csv"
    output_dir = "/global/scratch/users/anoonan/BRaVE/vibrio/vibrio_hierarchical_inv_freq_filter_mod"
