...
def main():
    ...
    interaction_matrix = "/global/scratch/users/anoonan/BRaVE/full_combined/full_interactions_dev2.csv"
    output_dir = "/global/scratch/users/anoonan/BRaVE/full_combined/bootstrapping/inverse_frequency_hierarchical_filter_update_50_2"
