...
def main():
    ...
    interaction_matrix = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/interactions/kleb_dimi2_interactions_long_update.csv"
    output_dir = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/kleb_Dimi2_modeling_phage_bootstrapping_inv_freq_filter"
