...
def main():
    ...
    output_dir = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/full_bootstrapping/kleb_Dimi1_inverse_frequency_hierarchical_feature_filter"
    ...
    mem_per_job = "180"                  # Memory per iteration job in GB (higher for strain+phage processing)
    ...
    max_ram = "180"                       # Max RAM usage in GB
