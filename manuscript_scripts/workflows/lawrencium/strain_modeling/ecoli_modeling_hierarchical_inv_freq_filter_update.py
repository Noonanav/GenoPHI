...
def main():
    ...
    output_dir = "/global/scratch/users/anoonan/BRaVE/ecoli/dataset_update/strain_modeling/ecoli_hierarchical_inv_freq_filter"
    ...
    max_ram = "120"                       # Maximum RAM usage in GB
