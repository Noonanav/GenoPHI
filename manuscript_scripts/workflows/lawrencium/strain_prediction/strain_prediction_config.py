...
def main():
    ...
    new_strain_dir = "/global/scratch/users/anoonan/BRaVE/new_strains"  # Directory with .faa files
    
    # Existing training results directory (contains strain/, phage/, modeling_results/, etc.)
    training_results_dir = "/global/scratch/users/anoonan/BRaVE/ecoli/ecoli_hierarchical_inv_freq_filter"
    
    # Output directory for predictions
    output_dir = "/global/scratch/users/anoonan/BRaVE/strain_predictions"
    ...
    max_parallel_jobs = 20               # Maximum number of parallel batch jobs
    ...
    mem_per_job = "60"                   # Memory per job in GB
    time_limit = "4:00:00"               # Time limit per batch job
    ...
    # =============================================
    cmd = [
        "python3", "slurm_strain_prediction_submit.py",
